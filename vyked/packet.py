...
class ControlPacket(_Packet):
    ...
    @classmethod
    def new_instance(cls, service_name, version, host, port, node_id, service_type):
        params = {'service': service_name, 'version': version, 'host': host, 'port': port, 'node_id': node_id,
